...
public class Reports_UI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Reports_UI frame = new Reports_UI();
	...
	public Reports_UI() {
		...
		btnSanPhamBan.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Report_Sales_UI report_Sales_UI = new Report_Sales_UI();
				report_Sales_UI.setLocationRelativeTo(null);
				report_Sales_UI.setVisible(true);
				setVisible(false);
			}
		});
		...
		btnSanPhamMua.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Report_Purchases_UI aeport_Purchases_Form = new Report_Purchases_UI ();
