...
public class Import_Bill_UI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Import_Bill_UI frame = new Import_Bill_UI();
	...
	private void ChiTietHoaDonNhap() {
		...
		if (iRow <= -1) {
			...
			Import_Bill_Detail_UI import_Bill_Detail_UI = new Import_Bill_Detail_UI(maHDN);
			import_Bill_Detail_UI.setLocationRelativeTo(null);
			import_Bill_Detail_UI.setVisible(true);
		}
