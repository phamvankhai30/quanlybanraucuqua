...
public class Providers_UI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Providers_UI frame = new Providers_UI();
	...
	public void initComponents() {
		...
		btnThem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Add_Provider_UI add_Provider_UI = new Add_Provider_UI();
				add_Provider_UI.setLocationRelativeTo(null);
				add_Provider_UI.setVisible(true);
			}
		});
		...
		btnSua.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (i <= -1) {
					...
					Update_Provider_UI update_Provider_UI = new Update_Provider_UI(id, ten, SDT, DiaChi);
					update_Provider_UI.setLocationRelativeTo(null);
					update_Provider_UI.setVisible(true);
				}
			}
		});
		...
		table_QLNCC.setModel(new DefaultTableModel(new Object[][] {
	...
	private void TimKiemNhaCCTheoId() {
		...
		if (textField_TimKiem.getText().equals("")) {
			...
			try {
				...
				if (providers != null) {
					model.addRow(new Object[] { providers.getIdProvider(), providers.getName(), providers.getPhone(),
