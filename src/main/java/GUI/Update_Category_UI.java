...
public class Update_Category_UI extends JFrame {
	...
	public Update_Category_UI(String maLoaiSP, String tenLoaiSP) {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Update_Category_UI frame = new Update_Category_UI("","");
