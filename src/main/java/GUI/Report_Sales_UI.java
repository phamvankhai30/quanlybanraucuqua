...
public class Report_Sales_UI extends JFrame {
	...
	public void initComponents() {
		...
		comboBox_FilterReportSales.setModel(new DefaultComboBoxModel<Object>(new String[] { "Mã Hoá Đơn Tăng Dần",
	...
	private void LocBaoCao() {
		if (comboBox_FilterReportSales.getSelectedItem().equals("Mã Hoá Đơn Tăng Dần")) {
			MaHoaDonTangDan();
		} else if (comboBox_FilterReportSales.getSelectedItem().equals("Mã Hoá Đơn Giảm Dần")) {
			MaHoaDonGiamDan();
		} else if (comboBox_FilterReportSales.getSelectedItem().equals("Mã Sản Phẩm Tăng Dần")) {
			MaSanPhamTangDan();
		} else if (comboBox_FilterReportSales.getSelectedItem().equals("Mã Sản Phẩm Giảm Dần")) {
			MaSanPhamGiamDan();
		} else if (comboBox_FilterReportSales.getSelectedItem().equals("Mã Nhân Viên Tăng Dần")) {
			MaNhanVienTangDan();
		} else if (comboBox_FilterReportSales.getSelectedItem().equals("Mã Nhân Viên Giảm Dần")) {
			MaNhanVienGiamDan();
		} else if (comboBox_FilterReportSales.getSelectedItem().equals("Tổng Tiền Tăng Dần")) {
			TongTienTangDan();
		} else if (comboBox_FilterReportSales.getSelectedItem().equals("Tổng Tiền Giảm Dần")) {
			TongTienGiamDan();
		}
	}
