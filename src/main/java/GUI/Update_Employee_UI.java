...
public class Update_Employee_UI extends JFrame {
	...
	public Update_Employee_UI(String idNV, String TenNV, String SDT, String DiaChi) {
		initComponents();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Update_Employee_UI frame = new Update_Employee_UI("", "", "", "");
