...
public class Products_UI extends JFrame {
	...
	public void initComponents() {
		...
		comboBox_filterProducts.setModel(new DefaultComboBoxModel<Object>(new String[] { "Số Lượng Tăng Dần",
				"Số Lượng Giảm Dần", "Mã Sản Phẩm Tăng Dần", "Mã Sản Phẩm Giảm Dần", "Mã Loại Tăng Dần",
				"Mã Loại Giảm Dần", "Giá Tiền Tăng Dần", "Giá Tiền Giảm Dần", "Mã Sản Nhà Cung Cấp Tăng Dần",
	...
	private void TimKiemSanPham() {
		if (textField_TimKiem.getText().equals("")) {
			...
			try {
				...
				Object[] columns = { "Mã Sản Phẩm", "Mã Loại Sản Phẩm", "Mã Nhà Cung Cấp", "Tên Sản Phẩm", "Số Lượng",
						"Giá Tiền", "Mô Tả", "Thời Gian" };
	...
	private void LocSanPham() {
		if (comboBox_filterProducts.getSelectedItem().equals("Số Lượng Tăng Dần")) {
			SoLuongTangDan();
		} else if (comboBox_filterProducts.getSelectedItem().equals("Số Lượng Giảm Dần")) {
			SoLuongGiamDan();
		} else if (comboBox_filterProducts.getSelectedItem().equals("Mã Sản Phẩm Tăng Dần")) {
			MaSanPhamTangDan();
		} else if (comboBox_filterProducts.getSelectedItem().equals("Mã Sản Phẩm Giảm Dần")) {
			MaSanPhamGiamDan();
		} else if (comboBox_filterProducts.getSelectedItem().equals("Mã Loại Tăng Dần")) {
			MaLoaiTangDan();
		} else if (comboBox_filterProducts.getSelectedItem().equals("Mã Loại Giảm Dần")) {
			MaLoaiGiamDan();
		} else if (comboBox_filterProducts.getSelectedItem().equals("Giá Tiền Tăng Dần")) {
			GiaTienTangDan();
		} else if (comboBox_filterProducts.getSelectedItem().equals("Giá Tiền Giảm Dần")) {
			GiaTienGiamDan();
		} else if (comboBox_filterProducts.getSelectedItem().equals("Mã Sản Nhà Cung Cấp Tăng Dần")) {
			MaNhaCungCapTangDan();
		} else if (comboBox_filterProducts.getSelectedItem().equals("Mã Sản Nhà Cung Cấp Giảm Dần")) {
			MaNhaCungCapGiamDan();
		} else if (comboBox_filterProducts.getSelectedItem().equals("Sắp Theo Tên Sản Phẩm A-Z")) {
			TenSanPhamAZ();
		} else if (comboBox_filterProducts.getSelectedItem().equals("Sắp Theo Tên Sản Phẩm Z-A")) {
			TenSanPhamZA();
		}
	}
